...
open class DAOBasketItem: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGBasketItemObject
    nonisolated(unsafe) public static var config: any Config = CFGBasketItemObject()
