...
open class DAOMedia: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGMediaObject
    nonisolated(unsafe) public static var config: any Config = CFGMediaObject()
