...
open class DAOAppActionThemes: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGAppActionThemesObject
    nonisolated(unsafe) public static var config: any Config = CFGAppActionThemesObject()
    ...
    nonisolated(unsafe) public static var defaultCancelButton = DNSThemeButtonStyle.default
    nonisolated(unsafe) public static var defaultOkayButton = DNSThemeButtonStyle.default
