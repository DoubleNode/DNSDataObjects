...
open class DAOFaq: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGFaqObject
    nonisolated(unsafe) public static var config: any Config = CFGFaqObject()
