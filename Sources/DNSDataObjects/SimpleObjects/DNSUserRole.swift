...
public enum DNSUserRole: Int, CaseIterable, Codable {
    ...
    public var isAdminSuperUser: Bool { self.rawValue == DNSUserRole.superUser.rawValue }
    public var isAdminSupport: Bool { self.rawValue <= DNSUserRole.supportViewer.rawValue }
    public var isAdminRegional: Bool { self.rawValue <= DNSUserRole.regionalViewer.rawValue }
    public var isAdminDistrict: Bool { self.rawValue <= DNSUserRole.districtViewer.rawValue }
    public var isAdminPlace: Bool { self.rawValue <= DNSUserRole.placeViewer.rawValue }
    public var isAdmin: Bool { self.rawValue <= DNSUserRole.placeViewer.rawValue }
