...
open class DAOTransaction: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGTransactionObject
    nonisolated(unsafe) public static var config: any Config = CFGTransactionObject()
