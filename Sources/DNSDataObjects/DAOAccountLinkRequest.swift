...
open class DAOAccountLinkRequest: DAOChangeRequest, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGAccountLinkRequestObject
    nonisolated(unsafe) public static var config: any Config = CFGAccountLinkRequestObject()
