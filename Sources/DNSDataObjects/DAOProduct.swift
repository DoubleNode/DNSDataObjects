...
open class DAOProduct: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGProductObject
    nonisolated(unsafe) public static var config: any Config = CFGProductObject()
