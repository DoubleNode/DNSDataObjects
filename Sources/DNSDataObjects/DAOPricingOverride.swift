...
public protocol PTCLCFGDAOPricingOverride: PTCLCFGBaseObject {
    var pricingOverrideType: DAOPricingOverride.Type { get }
    func pricingOverride<K>(from container: KeyedDecodingContainer<K>,
                        forKey key: KeyedDecodingContainer<K>.Key) -> DAOPricingOverride? where K: CodingKey
    func pricingOverrideArray<K>(from container: KeyedDecodingContainer<K>,
                             forKey key: KeyedDecodingContainer<K>.Key) -> [DAOPricingOverride] where K: CodingKey
}

public protocol PTCLCFGPricingOverrideObject: PTCLCFGDAOPricingItem, PTCLCFGDAOPricingOverride {
}
public class CFGPricingOverrideObject: PTCLCFGPricingOverrideObject {
...
open class DAOPricingOverride: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding {
    public typealias Config = PTCLCFGPricingOverrideObject
    public static var config: Config = CFGPricingOverrideObject()
    ...
    required public init(from object: DAOPricingOverride) {
        super.init(from: object)
        self.update(from: object)
    }
    open func update(from object: DAOPricingOverride) {
    ...
    override open func dao(from data: DNSDataDictionary) -> DAOPricingOverride {
    ...
    static public func !=(lhs: DAOPricingOverride, rhs: DAOPricingOverride) -> Bool {
        lhs.isDiffFrom(rhs)
    }
    static public func ==(lhs: DAOPricingOverride, rhs: DAOPricingOverride) -> Bool {
        !lhs.isDiffFrom(rhs)
