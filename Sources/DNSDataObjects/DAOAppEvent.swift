...
open class DAOAppEvent: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGAppEventObject
    nonisolated(unsafe) public static var config: any Config = CFGAppEventObject()
