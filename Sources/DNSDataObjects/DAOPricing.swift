...
open class DAOPricing: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGPricingObject
    nonisolated(unsafe) public static var config: any Config = CFGPricingObject()
