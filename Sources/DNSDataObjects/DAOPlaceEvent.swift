...
open class DAOPlaceEvent: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGPlaceEventObject
    nonisolated(unsafe) public static var config: any Config = CFGPlaceEventObject()
