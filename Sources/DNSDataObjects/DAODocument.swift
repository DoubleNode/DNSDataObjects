...
open class DAODocument: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGDocumentObject
    nonisolated(unsafe) public static var config: any Config = CFGDocumentObject()
