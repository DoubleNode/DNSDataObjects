...
open class DAOAppAction: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGAppActionObject
    nonisolated(unsafe) public static var config: any Config = CFGAppActionObject()
