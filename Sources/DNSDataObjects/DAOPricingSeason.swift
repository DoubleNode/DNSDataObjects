...
open class DAOPricingSeason: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGPricingSeasonObject
    nonisolated(unsafe) public static var config: any Config = CFGPricingSeasonObject()
