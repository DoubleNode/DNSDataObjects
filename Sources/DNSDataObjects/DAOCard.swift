...
open class DAOCard: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGCardObject
    nonisolated(unsafe) public static var config: any Config = CFGCardObject()
