...
open class DAOEventDay: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGEventDayObject
    nonisolated(unsafe) public static var config: any Config = CFGEventDayObject()
