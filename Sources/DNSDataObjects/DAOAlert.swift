...
open class DAOAlert: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGAlertObject
    nonisolated(unsafe) public static var config: any Config = CFGAlertObject()
