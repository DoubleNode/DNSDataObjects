...
open class DAOSection: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGSectionObject
    nonisolated(unsafe) public static var config: any Config = CFGSectionObject()
