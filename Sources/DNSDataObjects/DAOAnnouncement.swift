...
open class DAOAnnouncement: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGAnnouncementObject
    nonisolated(unsafe) public static var config: any Config = CFGAnnouncementObject()
