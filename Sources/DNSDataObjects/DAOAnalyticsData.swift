...
open class DAOAnalyticsData: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGAnalyticsDataObject
    nonisolated(unsafe) public static var config: any Config = CFGAnalyticsDataObject()
