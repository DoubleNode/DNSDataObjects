...
open class DAOChat: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGChatObject
    nonisolated(unsafe) public static var config: any Config = CFGChatObject()
