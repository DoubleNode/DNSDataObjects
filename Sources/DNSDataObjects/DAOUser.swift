...
open class DAOUser: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding {
    ...
    public enum CodingKeys: String, CodingKey {
        case accounts, cards, consent, consentId, dob, email, favorites, myPlace, name, phone, type
    }

    open var consent: Date?
    open var consentId: String = ""
    open var dob: Date?
    ...
    open func update(from object: DAOUser) {
        ...
        self.consentId = object.consentId
        self.dob = object.dob
    ...
    override open func dao(from data: DNSDataDictionary) -> DAOUser {
        ...
        self.consentId = self.string(from: data[field(.consentId)] as Any?) ?? self.consentId
    ...
    override open var asDictionary: DNSDataDictionary {
        ...
        retval.merge([
            ...
            field(.consentId): self.consentId,
    ...
    private func commonInit(from decoder: Decoder, configuration: Config) throws {
        ...
        consentId = self.string(from: container, forKey: .consentId) ?? consentId
