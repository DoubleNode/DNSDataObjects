...
open class DAOPromotion: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGPromotionObject
    nonisolated(unsafe) public static var config: any Config = CFGPromotionObject()
