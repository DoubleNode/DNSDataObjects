...
open class DAOBasket: DAOBaseObject, DecodingConfigurationProviding, EncodingConfigurationProviding, @unchecked Sendable {
    public typealias Config = PTCLCFGBasketObject
    nonisolated(unsafe) public static var config: any Config = CFGBasketObject()
