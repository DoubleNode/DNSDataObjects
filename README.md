![DoubleNode Swift Framework](https://github.com/DoubleNode/DNSDataObjects/raw/master/DNSFrameworkLogo.png)
...
-   iOS 16.0+ / macCatalyts 16.0+ / tvOS 16.4+ / watchOS 9.4+ 
-   Xcode 14.3.1+
-   Swift 5.8+
...
```swift
dependencies: [
.package(url: "https://github.com/DoubleNode/DNSDataObjects.git", from: "1.12.2")
]
```
...
-   DNSDataContracts v1.12.1+
-   DNSDataTypes v1.12.2+
-   DNSError v1.12.0+
